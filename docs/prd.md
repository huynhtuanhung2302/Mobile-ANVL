...
- Story 2.3: Tactical Mission UI: Giao diện tác chiến hợp nhất tích hợp Bản đồ tương tác, Lộ trình Step-by-step và Media.
...
- Story 3.3: Dẫn đường Trong nhà: Chỉ dẫn logic (Tầng/Phòng) theo bối cảnh Indoor/Outdoor.
