...
- **Tác chiến Hợp nhất (Unified Hub)**: Tích hợp bản đồ tương tác, ETA, Khoảng cách và danh sách lộ trình ngay tại màn hình briefing.
- **Hỗ trợ Đa tầng (Indoor/Outdoor)**: Phân loại rõ ràng các bước dẫn đường Ngoài trời (GPS) và Trong nhà (Logic: Tầng/Phòng) kèm Floor Badge Neon Red.
- **Layer Management**: Quản lý hiển thị các lớp thông tin: Camera, Thiết bị IoT, Tòa nhà, Khu vực.
- **Interactive Map**: Cho phép nhấn mở rộng bản đồ toàn màn hình để quan sát chi tiết hơn.
...
graph TD
    ...
    I1 --> I2[2. Tác chiến Hiện trường/Briefing]
    I2 --> I3[3. Xem Lộ trình Indoor/Outdoor]
    I3 --> I4[4. Mở rộng Bản đồ/Dẫn đường]
