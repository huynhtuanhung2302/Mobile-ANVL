...
- **Navigation Panel:** Card hoặc Overlay hiển thị:
  - **ETA và Khoảng cách**: Tóm tắt ở header thẻ.
  - **Simplified Step List**: Danh sách Checklist toàn bộ các bước lộ trình, phân loại rõ ràng **Outdoor (GPS)** và **Indoor (Logic)**.
  - **Premium Floating Floor Badge**: Nhãn
